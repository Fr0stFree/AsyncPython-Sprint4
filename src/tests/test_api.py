...
@pytest.mark.asyncio
async def test_db_is_up_and_running(fastapi_app, client):
...
@pytest.mark.asyncio
async def test_url_create(fastapi_app, session, client):
...
@pytest.mark.asyncio
async def test_duplicate_url_create(fastapi_app, session, client):
    response = await client.post(fastapi_app.url_path_for('create'), json={'full_url': 'https://google.com'})
    assert response.status_code == HTTPStatus.CREATED
...
@pytest.mark.asyncio
async def test_url_get_redirect(fastapi_app, client):
    response = await client.post(fastapi_app.url_path_for('create'), json={'full_url': 'https://google.com'})
...
@pytest.mark.asyncio
async def test_url_ban(fastapi_app, client):
    response = await client.post(fastapi_app.url_path_for('create'), json={'full_url': 'https://google.com'})
    shorten_url = response.json()['shorten_url']
...
@pytest.mark.asyncio
async def test_url_get_unexisting(client):
...
@pytest.mark.asyncio
async def test_url_status_full(fastapi_app, session, client):
    response = await client.post(fastapi_app.url_path_for('create'), json={'full_url': 'https://google.com'})
    shorten_url = response.json()['shorten_url']
    url_id = shorten_url.split('/')[-1]
...
@pytest.mark.asyncio
async def test_url_status_short(fastapi_app, session, client):
    response = await client.post(fastapi_app.url_path_for('create'), json={'full_url': 'https://google.com'})
    shorten_url = response.json()['shorten_url']
    url_id = shorten_url.split('/')[-1]
    await asyncio.gather(*[client.get(shorten_url) for _ in range(5)])
...
@pytest.mark.asyncio
async def test_url_status_limit_and_offset(fastapi_app, session, client):
    response = await client.post(fastapi_app.url_path_for('create'), json={'full_url': 'https://google.com'})
    shorten_url = response.json()['shorten_url']
    url_id = shorten_url.split('/')[-1]
...
@pytest.mark.asyncio
async def test_url_bulk_create(fastapi_app, session, client):
    links = ['https://google.com', 'https://github.com', 'https://www.youtube.com']
    response = await client.post(fastapi_app.url_path_for('bulk_create'), json=[{'full_url': links[0]},
                                                                                {'full_url': links[1]},
                                                                                {'full_url': links[2]}])
